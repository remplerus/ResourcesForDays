...
public class RfDBlockStateGen extends BlockStateProvider {
    ...
    protected void registerStatesAndModels() {
        ...
        createGenModels(ModBlocks.COBBLE_GEN_T1.get(),mcLoc(blockLoc + "cobblestone"), tier1);
        createGenModels(ModBlocks.COBBLE_GEN_T2.get(),mcLoc(blockLoc + "cobblestone"), tier2);
        createGenModels(ModBlocks.COBBLE_GEN_T3.get(),mcLoc(blockLoc + "cobblestone"), tier3);
        createGenModels(ModBlocks.COBBLE_GEN_T4.get(),mcLoc(blockLoc + "cobblestone"), tier4);
        createGenModels(ModBlocks.COBBLE_GEN_T5.get(),mcLoc(blockLoc + "cobblestone"), tier5);
